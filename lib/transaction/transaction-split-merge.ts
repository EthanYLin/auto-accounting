 ...
 */
function getDefaultSplit(tx: TransactionWithRelations | TransactionSplitWithRelations): TransactionSplitWithRelations {
  return {
    id: tx.id,
    amount: tx.amount,
    name: tx.name ?? null,
 ...
 */
export function defaultMerge(tx: TransactionWithRelations | TransactionSplitWithRelations, children: TransactionWithRelations[] | TransactionSplitWithRelations[]): TransactionSplitWithRelations[] {
